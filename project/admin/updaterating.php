...
<?php
$sql = "SELECT pid, pname, pemail, pcourse, puniversity, rid, p_fk, rdate, rrating, rdifficulty, rtag,   ragain, rcomments from tblprofessor_skhan27 JOIN tblrating_skhan27 ON tblprofessor_skhan27.pid = tblrating_skhan27.p_fk where rid=$rid";
