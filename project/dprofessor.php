...
?>	
				...
				$sql = "SELECT pid, pname, pcourse, puniversity,p_fk, rdate, rrating, rdifficulty, rtag,   ragain, rcomments from tblprofessor_skhan27 JOIN tblrating_skhan27 ON tblprofessor_skhan27.pid = tblrating_skhan27.p_fk Where tblrating_skhan27.p_fk=$id order by rid desc";
				//echo $sql;
